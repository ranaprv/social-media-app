...
# createCacheNodeForSegment()

## Connections
- [[createCacheNode()_10]] - `calls` [EXTRACTED]
- [[createCacheNodeOnNavigation()_10]] - `calls` [EXTRACTED]
- [[createDeferredRsc()_10]] - `calls` [EXTRACTED]
- [[isDeferredRsc()_10]] - `calls` [EXTRACTED]
- [[node_modules_next_dist_client_0r5nbpw._.js]] - `contains` [EXTRACTED]
- [[updateCacheNodeOnNavigation()_10]] - `calls` [EXTRACTED]
